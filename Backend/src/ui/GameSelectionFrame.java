...
public class GameSelectionFrame extends JFrame {
     ...
     * 기본 생성자
     */
    public GameSelectionFrame(String username) {
     ...
     */
    public GameSelectionFrame(String username, Rectangle bounds, boolean maximized) {
        this.currentUser = username;
        
        setTitle("ZOOM Defense - 게임 선택");
    ...
    private JPanel createMainPanel() {
        ...
        lblWelcome = new PixelLabel(currentUser + "님 환영합니다", SwingConstants.CENTER);
        ...
        btnNewGame.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                JOptionPane.showMessageDialog(GameSelectionFrame.this, 
                        "새 게임 기능은 아직 구현되지 않았습니다.", 
                        "개발 중", 
